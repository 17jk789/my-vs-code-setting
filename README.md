...
```json
{
    ...
    // "vim.statusBarColors.commandlineinprogress": ["#1e1e2e", "#cdd6f4"],
    // "vim.statusBarColors.searchinprogressmode": ["#1e1e2e", "#cdd6f4"],
    // "vim.statusBarColors.easymotionmode": ["#f9e2af", "#11111b"],
    // "vim.statusBarColors.easymotioninputmode": ["#f9e2af", "#11111b"],
    // "vim.statusBarColors.surroundinputmode": ["#94e2d5", "#11111b"],
    "editor.wordWrap": "off",
